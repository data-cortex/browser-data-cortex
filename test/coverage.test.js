...
describe('DataCortex Library Coverage Tests', () => {
  ...
  describe('Browser Environment Detection', () => {
    test('should detect browser information from user agent', () => {
      ...
      const storedDeviceTag = JSON.parse(global.localStorage.getItem('dc.device_tag'));
    ...
    test('should detect different browsers from user agent', () => {
      ...
      // Test Android
      Object.defineProperty(global.navigator, 'userAgent', {
        value: 'Mozilla/5.0 (Linux; Android 13; SM-G991B) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/115.0.0.0 Mobile Safari/537.36',
        configurable: true
      });
  ...
  describe('Advanced Configuration', () => {
    test('should handle base_url from localStorage', () => {
      global.localStorage.setItem('dc.base_url', '"https://stored-api.example.com"');
